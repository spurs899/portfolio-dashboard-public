...
// Holdings management services
builder.Services.AddScoped<IHoldingsStorageService, LocalHoldingsStorageService>();

if (isDemoMode)
{
    builder.Services.AddScoped<ITickerSearchService, MockTickerSearchService>();
    builder.Services.AddScoped<IPriceService, MockPriceService>();
    Console.WriteLine("[Demo Mode] Using mock ticker search and price services");
}
else
{
    builder.Services.AddScoped<ITickerSearchService, FinnhubTickerSearchService>();
    builder.Services.AddScoped<IPriceService, FinnhubPriceService>();
}
